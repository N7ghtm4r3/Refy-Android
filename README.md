...
This project, based on Java and the Spring Boot framework, it's an open source self-hosted references
collector and custom links generator.

Trace your revenues with **Refy**!

This repository contains the android version of **Refy**,
...
- <a href="https://github.com/N7ghtm4r3/Refy/releases/tag/1.0.0">Backend service "
  out-of-the-box"</a>

## Usages

See how to use the **Refy** service reading
the <a href="https://github.com/N7ghtm4r3/Refy#readme">
Refy backend procedures</a>
...
- Support via <a href="https://github.com/N7ghtm4r3/Refy-Android/issues/new">GitHub</a>
...
Store. <br>
Refy application **will not share any personal data of the user with third part applications.**
